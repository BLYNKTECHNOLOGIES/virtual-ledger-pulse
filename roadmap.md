...
# [x] Terminal merged counterparty chat history: stable account-scoped identity, canceled-order recovery, read-only prior-order timeline, and runtime verification
