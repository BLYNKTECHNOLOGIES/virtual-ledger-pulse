  ...
  },
  {
    ...
    element: (
      <QueryProvider>
          <AuthCheck>
            <Layout>
              <PermissionGate permissions={["clients_view", "clients_manage", "kyc_approvals_view", "kyc_approvals_manage", "ra_assign"]}>
                <Clients />
              </PermissionGate>
            </Layout>
          </AuthCheck>
  ...
  },
  {
    ...
    element: (
      <QueryProvider>
          <AuthCheck>
            <Layout>
              <PermissionGate permissions={["tax_management_view", "tax_management_manage"]}>
                <Accounting />
              </PermissionGate>
            </Layout>
          </AuthCheck>
  ...
  },
  {
    ...
    element: (
      <QueryProvider>
          <AuthCheck>
            <Layout>
              <PermissionGate permissions={["profit_loss_view"]}>
                <ProfitLoss />
              </PermissionGate>
            </Layout>
          </AuthCheck>
  ...
  },
  {
    ...
    element: (
      <QueryProvider>
          <AuthCheck>
            <Layout>
              <PermissionGate permissions={["financials_view", "financials_manage"]}>
                <Financials />
              </PermissionGate>
            </Layout>
          </AuthCheck>
    ...
    },
   {
    ...
    // Horilla HRMS — Isolated layout, no ERP shell
    {
      ...
      children: [
        ...
        { path: "employee", element: hrmsGate(["hrms_view", "hrms_manage"], <EmployeeListPage />) },
        { path: "employee/departments", element: hrmsGate(["hrms_view", "hrms_manage"], <DepartmentsPage />) },
        { path: "employee/positions", element: hrmsGate(["hrms_view", "hrms_manage"], <PositionsPage />) },
        { path: "employee/:id", element: hrmsGate(["hrms_view", "hrms_manage"], <EmployeeProfilePage />) },
        { path: "attendance", element: hrmsGate(["hrms_view", "hrms_manage"], <AttendanceOverviewPage />) },
        { path: "attendance/biometric-devices", element: hrmsGate(["hrms_view", "hrms_manage"], <BiometricDevicesPage />) },
        { path: "attendance/calendar", element: hrmsGate(["hrms_view", "hrms_manage"], <AttendanceCalendarPage />) },
        { path: "attendance/shifts", element: hrmsGate(["hrms_view", "hrms_manage"], <ShiftsPage />) },
        { path: "attendance/overtime", element: <Navigate to="/hrms/attendance/hours" replace /> },
        
        { path: "attendance/hours", element: hrmsGate(["hrms_view", "hrms_manage"], <HoursOverviewPage />) },
        { path: "attendance/hour-accounts", element: <Navigate to="/hrms/attendance/hours" replace /> },
        { path: "attendance/late-early", element: hrmsGate(["hrms_view", "hrms_manage"], <LateComeEarlyOutPage />) },
        { path: "attendance/summary", element: hrmsGate(["hrms_view", "hrms_manage"], <AttendanceSummaryPage />) },
       ...
       { path: "attendance/stale-sessions", element: hrmsGate(["hrms_view", "hrms_manage"], <AttendanceStaleSessionsPage />) },
        { path: "attendance/day/:employeeId/:date", element: hrmsGate(["hrms_view", "hrms_manage"], <AttendanceDayDetailPage />) },
        { path: "attendance/period-locks", element: hrmsGate(["hrms_view", "hrms_manage"], <AttendancePeriodLockPage />) },
        { path: "leave", element: hrmsGate(["hrms_view", "hrms_manage"], <LeaveDashboardPage />) },
        { path: "leave/requests", element: hrmsGate(["hrms_view", "hrms_manage"], <LeaveRequestsPage />) },
        { path: "leave/allocations", element: hrmsGate(["hrms_view", "hrms_manage"], <LeaveAllocationsPage />) },
        { path: "leave/allocations/history", element: hrmsGate(["hrms_view", "hrms_manage"], <LeaveLedgerHistoryPage />) },
        { path: "leave/types", element: hrmsGate(["hrms_view", "hrms_manage"], <LeaveTypesPage />) },
        { path: "leave/holidays", element: hrmsGate(["hrms_view", "hrms_manage"], <HolidaysPage />) },
        { path: "leave/comp-off", element: hrmsGate(["hrms_view", "hrms_manage"], <CompOffPage />) },
        { path: "leave/accrual-plans", element: hrmsGate(["hrms_view", "hrms_manage"], <LeaveAccrualPlansPage />) },
        { path: "leave/allocation-requests", element: hrmsGate(["hrms_view", "hrms_manage"], <LeaveAllocationRequestsPage />) },
        { path: "leave/weekly-off", element: hrmsGate(["hrms_view", "hrms_manage"], <WeeklyOffPage />) },
        { path: "payroll", element: hrmsGate(["hrms_view", "hrms_manage"], <PayrollDashboardPage />) },
        { path: "payroll/payslips", element: hrmsGate(["hrms_view", "hrms_manage"], <PayslipsPage />) },
        { path: "payroll/salary-components", element: hrmsGate(["hrms_view", "hrms_manage"], <SalaryComponentsPage />) },
        ...
        { path: "payroll/penalties", element: hrmsGate(["hrms_view", "hrms_manage"], <PenaltyManagementPage />) },
        { path: "payroll/deposits", element: hrmsGate(["hrms_view", "hrms_manage"], <DepositManagementPage />) },
        { path: "payroll/loans", element: hrmsGate(["hrms_view", "hrms_manage"], <LoansPage />) },
        { path: "asset", element: hrmsGate(["hrms_view", "hrms_manage"], <AssetDashboardPage />) },
        { path: "asset/list", element: hrmsGate(["hrms_view", "hrms_manage"], <AssetPage />) },
        { path: "asset/assignments", element: hrmsGate(["hrms_view", "hrms_manage"], <AssetAssignmentsPage />) },
        { path: "pms", element: hrmsGate(["hrms_view", "hrms_manage"], <PMSDashboardPage />) },
        
        { path: "pms/feedback", element: hrmsGate(["hrms_view", "hrms_manage"], <Feedback360Page />) },
        { path: "pms/mpi", element: hrmsGate(["hrms_view", "hrms_manage"], <MPIPage />) },
        // offboarding route removed — merged into HRMS Separation tab
        { path: "offboarding/fnf", element: hrmsGate(["hrms_view", "hrms_manage"], <FnFSettlementPage />) },
        { path: "employee/documents", element: hrmsGate(["hrms_view", "hrms_manage"], <EmployeeDocumentsPage />) },
        { path: "employee/separation", element: hrmsGate(["hrms_view", "hrms_manage"], <SeparationPage />) },
        { path: "payroll/salary-revisions", element: hrmsGate(["hrms_view", "hrms_manage"], <SalaryRevisionsPage />) },
        { path: "payroll/statutory-settings", element: hrmsGate(["hrms_view", "hrms_manage"], <StatutorySettingsPage />) },

        { path: "payroll/penalty-calc", element: <Navigate to="/hrms/payroll/penalties" replace /> },
        { path: "payroll/razorpay-sync", element: hrmsGate(["hrms_view", "hrms_manage"], <RazorpaySyncPage />) },
        
        
        { path: "payroll/payslip-history-import", element: hrmsGate(["hrms_view", "hrms_manage"], <PayslipHistoryImportPage />) },
        { path: "payroll/salary-register-import", element: hrmsGate(["hrms_view", "hrms_manage"], <SalaryRegisterImportPage />) },
        { path: "payroll/inputs", element: hrmsGate(["hrms_view", "hrms_manage"], <PayrollInputsPage />) },
        { path: "payroll/shadow-calculator", element: hrmsGate(["hrms_view", "hrms_manage"], <ShadowPayrollPage />) },
        { path: "payroll/cockpit", element: hrmsGate(["hrms_view", "hrms_manage"], <MonthlyPayrollCockpitPage />) },
        { path: "system-pulse", element: hrmsGate(["hrms_view", "hrms_manage"], <SystemPulsePage />) },
        { path: "data-health", element: hrmsGate(["hrms_view", "hrms_manage"], <DataHealthPage />) },
        { path: "helpdesk", element: hrmsGate(["hrms_view", "hrms_manage"], <HelpdeskPage />) },
        ...
        { path: "announcements", element: hrmsGate(["hrms_view", "hrms_manage"], <AnnouncementsPage />) },
        { path: "reports", element: hrmsGate(["hrms_view", "hrms_manage"], <ReportsPage />) },
        { path: "registers", element: hrmsGate(["hrms_view", "hrms_manage"], <RegistersPage />) },
        { path: "reports/salary-register-projection", element: hrmsGate(["hrms_view", "hrms_manage"], <SalaryRegisterProjectionPage />) },
        { path: "onboarding-pipeline", element: hrmsGate(["hrms_view", "hrms_manage"], <EmployeeOnboardingPipelinePage />) },
        { path: "disciplinary-actions", element: hrmsGate(["hrms_view", "hrms_manage"], <DisciplinaryActionsPage />) },
        
        { path: "logs", element: hrmsGate(["hrms_view", "hrms_manage"], <HRLogsPage />) },
        { path: "mailbox", element: hrmsGate(["hrms_view", "hrms_manage"], <MailboxPage />) },
        { path: "recruitment", element: hrmsGate(["hrms_view", "hrms_manage"], <RecruitmentDashboardPage />) },
        { path: "recruitment/pipeline", element: hrmsGate(["hrms_view", "hrms_manage"], <RecruitmentPipelinePage />) },
        { path: "recruitment/candidates", element: hrmsGate(["hrms_view", "hrms_manage"], <CandidatesListPage />) },
        { path: "recruitment/candidates/:id", element: hrmsGate(["hrms_view", "hrms_manage"], <CandidateProfilePage />) },
        { path: "recruitment/interviews", element: hrmsGate(["hrms_view", "hrms_manage"], <InterviewListPage />) },
        { path: "recruitment/stages", element: hrmsGate(["hrms_view", "hrms_manage"], <StagesPage />) },
