import { Calendar, Home, Users, Building2, CreditCard, TrendingUp, UserCheck, Calculator, Scale, Package, BookOpen, ShoppingCart, Info } from "lucide-react";
      ...
      <Sidebar>
        <SidebarHeader className="p-4">
          <div className="flex items-center gap-3">
            <img src="/lovable-uploads/25d24f27-f300-4057-b894-aa71e4e6fe12.png" alt="Blynk Virtual Technologies" className="h-8 w-auto" />
            <div>
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent side="right" className="max-w-sm p-4">
                        <div className="space-y-2">
                          ...
                          {item.detailedInfo && <div className="text-xs text-muted-foreground whitespace-pre-line">
                              {item.detailedInfo}
                            </div>}
                        </div>
                      </TooltipContent>
