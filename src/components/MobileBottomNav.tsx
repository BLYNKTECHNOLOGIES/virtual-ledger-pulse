...
const moreNavItems: MobileNavItem[] = [
  ...
  { title: "Tax Management", url: "/accounting", icon: Package, permissions: ["tax_management_view", "tax_management_manage", "accounting_view"] },
  { title: "P&L", url: "/profit-loss", icon: TrendingUp, permissions: ["profit_loss_view", "accounting_view", "accounting_manage"] },
  { title: "Financials", url: "/financials", icon: Package, permissions: ["financials_view", "financials_manage", "accounting_view"] },
