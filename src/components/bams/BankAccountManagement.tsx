...
export function BankAccountManagement() {
  ...
  return <div className="space-y-6 px-[15px]">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input id="bank_account_holder_name" value={formData.bank_account_holder_name} onChange={e => setFormData(prev => ({
                  ...prev,
                ...
                <div>
                  ...
                  <Input id="bank_name" value={formData.bank_name} onChange={e => setFormData(prev => ({
                  ...prev,
                ...
                <div>
                  ...
                  <Input id="account_number" value={formData.account_number} onChange={e => setFormData(prev => ({
                  ...prev,
                ...
                <div>
                  ...
                  <Input id="ifsc_code" value={formData.ifsc_code} onChange={e => setFormData(prev => ({
                  ...prev,
                ...
                <div>
                  ...
                  <Input id="branch" value={formData.branch} onChange={e => setFormData(prev => ({
                  ...prev,
                ...
                <div>
                  ...
                  <Input id="balance" type="number" min="0" step="0.01" value={formData.balance} onChange={e => setFormData(prev => ({
                  ...prev,
                ...
                <div>
                  ...
                  <Select value={formData.status} onValueChange={(value: "ACTIVE" | "INACTIVE") => setFormData(prev => ({
                  ...prev,
                  status: value
                }))}>
                    <SelectTrigger>
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button type="submit" disabled={createAccountMutation.isPending || updateAccountMutation.isPending}>
                  {createAccountMutation.isPending || updateAccountMutation.isPending ? "Processing..." : editingAccount ? "Update Account" : "Add Account"}
                </Button>
              </div>
            </form>
          </DialogContent>
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? <div className="text-center py-8">Loading bank accounts...</div> : <Table>
              <TableHeader>
                <TableRow>
              ...
              <TableBody>
                {bankAccounts?.map(account => <TableRow key={account.id}>
                    ...
                    <TableCell>
                      <Badge variant={account.status === "ACTIVE" ? "default" : "destructive"}>
                        {account.status === "ACTIVE" ? <><Eye className="h-3 w-3 mr-1" /> Active</> : <><EyeOff className="h-3 w-3 mr-1" /> Inactive</>}
                      </Badge>
                    </TableCell>
                    <TableCell>
                      <Button variant="outline" size="sm" onClick={() => handleEdit(account)} className="flex items-center gap-1">
                        <Edit className="h-3 w-3" />
                        Edit
                      </Button>
                    </TableCell>
                  </TableRow>)}
                {bankAccounts?.length === 0 && <TableRow>
