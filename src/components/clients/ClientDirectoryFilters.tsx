...
// Filter Button Component (for inline placement)
...
// Filter Content Panel Component (for below the row)
export function ClientDirectoryFilterPanel({ 
  ...
  return (
    <div className="mt-4 rounded-lg border bg-card p-4 space-y-5">
