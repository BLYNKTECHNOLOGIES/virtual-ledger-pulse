...
export const PAGE_ROUTES: PageRoute[] = [
  ...
  { label: "Attendance", path: "/hrms/attendance/overview", icon: CalendarClock, keywords: "punches shifts activity" },
  ...
  { label: "Assets", path: "/hrms/assets", icon: Boxes, keywords: "asset assignments equipment" },
