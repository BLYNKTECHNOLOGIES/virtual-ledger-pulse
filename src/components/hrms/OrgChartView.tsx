          ...
          >
            ...
            <div className="absolute top-3 right-3 z-20 flex flex-col gap-1">
              <div className="flex gap-0.5">
                <Button variant="secondary" size="icon" aria-label="Zoom in" className="h-8 w-8 rounded-md shadow-sm" onClick={() => handleZoom("in")}>
                  <ZoomIn className="h-4 w-4" />
                </Button>
                <Button variant="secondary" size="icon" aria-label="Zoom out" className="h-8 w-8 rounded-md shadow-sm" onClick={() => handleZoom("out")}>
              ...
              <div className="grid grid-cols-3 gap-0.5 mt-1">
                <div />
                <Button variant="secondary" size="icon" aria-label="Pan up" className="h-7 w-7 rounded-md shadow-sm" onClick={() => handlePan("up")}>
                  <ArrowUp className="h-3 w-3" />
                </Button>
                <div />
                <Button variant="secondary" size="icon" aria-label="Pan left" className="h-7 w-7 rounded-md shadow-sm" onClick={() => handlePan("left")}>
                  <ArrowLeft className="h-3 w-3" />
                </Button>
                <div />
                <Button variant="secondary" size="icon" aria-label="Pan right" className="h-7 w-7 rounded-md shadow-sm" onClick={() => handlePan("right")}>
                  <ArrowRight className="h-3 w-3" />
                </Button>
                <div />
                <Button variant="secondary" size="icon" aria-label="Pan down" className="h-7 w-7 rounded-md shadow-sm" onClick={() => handlePan("down")}>
