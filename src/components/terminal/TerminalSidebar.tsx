...
const navItems: NavItem[] = [
  ...
  { title: 'Assets', url: '/terminal/assets', icon: Wallet, requiredPermission: 'terminal_assets_view' },
  { title: 'Analytics', url: '/terminal/analytics', icon: Activity, requiredPermission: 'terminal_analytics_view' },
  { title: 'MPI', url: '/terminal/mpi', icon: BarChart3, requiredPermission: 'terminal_mpi_view' },
