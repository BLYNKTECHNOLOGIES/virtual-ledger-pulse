...
export function OperatorAssignmentManager() {
  ...
  // Fetch users who have terminal_orders_view permission (operators)
            ...
            <div className="space-y-4 pt-2">
              <div className="space-y-2">
                ...
                {operatorUsers.length === 0 && (
                  <p className="text-[10px] text-amber-500">No users have the Orders permission. Assign a role with Orders access first.</p>
                )}
              </div>
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-border hover:bg-transparent">
                  <TableHead className="text-[10px] text-muted-foreground font-medium">Operator</TableHead>
