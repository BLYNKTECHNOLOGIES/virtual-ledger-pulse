...
export const NAVIGATION_SHORTCUTS: ShortcutDef[] = [
  ...
  { id: "nav-accounting", category: "Navigation", label: "Tax Management", description: "Go to Tax / Accounting", combo: A("KeyX"), icon: BookOpen, url: "/accounting", permissions: ["tax_management_view", "tax_management_manage"] },
  { id: "nav-financials", category: "Navigation", label: "Financials", description: "Go to Financials", combo: A("KeyF"), icon: Calculator, url: "/financials", permissions: ["financials_view", "financials_manage"] },
