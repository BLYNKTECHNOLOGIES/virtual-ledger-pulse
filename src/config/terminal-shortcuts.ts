 ...
 *    and Alt+1–Alt+9 quick-reply composer keys).
...
export const TERMINAL_NAVIGATION_SHORTCUTS: TerminalShortcutDef[] = [
  ...
  { id: "t-nav-ad-uptime", category: "Navigation", label: "Ad Active Time", description: "Go to shift-wise ad active time", keys: ["Alt", "Shift", "U"], scope: "Any terminal page", combo: AS("KeyU"), icon: BarChart3, url: "/terminal/ad-uptime", permissions: ["terminal_ad_uptime_view"] },
...
export const TERMINAL_ORDERS_SHORTCUTS: TerminalShortcutDef[] = [
  ...
  { id: "t-orders-back", category: "Orders", label: "Back to List", description: "Return from an open order or Queue Mode to the list", keys: ["U"], scope: "Orders list / detail / Queue Mode", icon: CornerUpLeft, permissions: [] },
