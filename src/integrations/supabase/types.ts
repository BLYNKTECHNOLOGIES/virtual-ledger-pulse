...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      bank_cases: {
        Row: {
          ...
          lien_acknowledgment_number: string | null
      ...
      bank_transactions: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["related_transaction_id"]
            isOneToOne: false
            referencedRelation: "fin_hash_chain_check_v"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "bank_transactions_related_transaction_id_fkey"
            columns: ["related_transaction_id"]
            isOneToOne: false
            referencedRelation: "fin_intercompany_v"
            referencedColumns: ["counter_leg_id"]
          },
          {
            foreignKeyName: "bank_transactions_related_transaction_id_fkey"
            columns: ["related_transaction_id"]
          ...
          },
          {
            ...
            columns: ["related_transaction_id"]
            isOneToOne: false
            referencedRelation: "fin_transfer_pair_v"
          ...
          },
          {
            ...
            columns: ["related_transaction_id"]
            isOneToOne: false
            referencedRelation: "fin_transfer_unpaired_v"
            referencedColumns: ["id"]
          },
          {
      ...
      hr_employee_salary_structures: {
        Row: {
          ...
          synced_from_razorpay_employee_id: string | null
          updated_at: string
        }
        Insert: {
          amount?: number
    ...
    Views: {
      ...
      fin_intercompany_position_v: {
        Row: {
          ...
          counterparty_subsidiary_id: string | null
          funded_to_counterparty: number | null
          last_movement_date: string | null
          legal_name: string | null
          movement_count: number | null
          net_position: number | null
          received_from_counterparty: number | null
          subsidiary_id: string | null
        }
        Relationships: []
      }
      ...
      fin_transfer_pair_v: {
        Row: {
          ...
          counter_legal_name: string | null
          counter_subsidiary_id: string | null
          counter_txn_id: string | null
          counter_unmapped: boolean | null
          description: string | null
          is_reversed: boolean | null
          legal_name: string | null
          pair_key: string | null
      ...
      hr_razorpay_payroll_freshness: {
        Row: {
          badge_id: string | null
          has_register_csv: boolean | null
          hours_since_pull: number | null
          hr_employee_id: string | null
          last_pulled_at: string | null
          name: string | null
          period_month: string | null
          razorpay_employee_id: string | null
          register_csv_uploaded_at: string | null
        }
        Relationships: []
      }
    ...
    Functions: {
      ...
      fin_entity_opening_position: {
        Args: { p_opening_date?: string; p_subsidiary_id: string }
        Returns: {
          account_name: string
          anchor_at: string
          ...
          bank_name: string
          basis: string
          derived_opening_balance: number
          movement_between: number
        }[]
      }
