...
export async function buildVerificationPack(period: string): Promise<VerificationPack> {
  ...
  const metaFor = (title: string, extra: string[][] = []): string[][] => [
    ...
    ...extra,
    ["Source of figures", "Step 4 LOP engine, Step 5 comp-off engine and the staged Step 6 payroll inputs / auto-recoveries of this cycle — nothing is recomputed outside those steps."],
