...
export default function TerminalAppeals() {
  ...
  const syncAppealOrders = async () => {
    setIsSyncing(true);
    try {
      const resp: any = await callBinanceAds('listActiveOrders', { rows: 100, orderStatusList: [8, 'APPEAL', 'DISPUTE'] });
