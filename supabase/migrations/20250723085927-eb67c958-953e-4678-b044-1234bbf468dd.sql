...
-- Delete all business transactions and orders first
...
-- Delete sales orders and related data
DELETE FROM public.sales_order_items;
DELETE FROM public.sales_orders;

-- Delete payment methods that reference bank accounts
DELETE FROM public.sales_payment_methods;
...
-- Delete banking data after removing references
