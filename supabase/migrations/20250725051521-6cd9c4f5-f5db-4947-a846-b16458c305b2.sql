...
-- Insert default investigation steps template
INSERT INTO public.investigation_steps (investigation_id, step_number, step_title, step_description)
SELECT 
  '00000000-0000-0000-0000-000000000000'::uuid,
  1,
  'Initial Assessment',
  'Analyze account status and determine root cause of inactiveness'
UNION ALL
SELECT 
  '00000000-0000-0000-0000-000000000000'::uuid,
  2,
  'Bank Communication',
  'Contact bank to understand the specific issues and requirements'
UNION ALL
SELECT 
  '00000000-0000-0000-0000-000000000000'::uuid,
  3,
  'Documentation Review',
  'Review all account documents and compliance requirements'
UNION ALL  
SELECT 
  '00000000-0000-0000-0000-000000000000'::uuid,
  4,
...
SELECT 
  ...
  5,
  'Verification',
  'Verify that all issues have been resolved and account is functional';