...
DROP TRIGGER IF EXISTS trigger_create_purchase_bank_transaction ON purchase_orders;
DROP FUNCTION IF EXISTS public.create_purchase_bank_transaction() CASCADE;