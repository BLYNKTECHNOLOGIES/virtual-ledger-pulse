-- Fix purchase order bank transaction creation by updating missing bank_account_id

-- 1) First, ensure all recent purchase orders have proper bank_account_id
...
-- 2) Create missing bank transactions for ALL purchase orders that don't have them
...
-- 3) Update the purchase order trigger to be more reliable
