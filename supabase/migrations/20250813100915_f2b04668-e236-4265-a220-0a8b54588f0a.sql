...
ALTER TABLE public.bank_accounts DROP CONSTRAINT IF EXISTS check_bank_balance_positive;

-- Now create missing bank transactions (this will trigger balance updates)
...
-- Create missing bank transactions for sales orders too
INSERT INTO public.bank_transactions (
  bank_account_id,
  transaction_type,
  amount,
...
-- Create triggers for future transactions
