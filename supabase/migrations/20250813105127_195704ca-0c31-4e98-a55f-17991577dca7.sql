-- Create a special function to handle manual purchase orders that can temporarily unlock accounts
...
DECLARE
  ...
  was_locked BOOLEAN;
BEGIN
  -- Check if bank account is locked and temporarily unlock it
