...
DROP FUNCTION IF EXISTS create_manual_purchase_secure(text, text, date, text, numeric, text, uuid, numeric, numeric, uuid, uuid);
DROP FUNCTION IF EXISTS create_manual_purchase_secure(text, text, date, numeric, text, uuid, numeric, numeric, uuid, uuid);

-- Recreate the correct function with proper parameter order
