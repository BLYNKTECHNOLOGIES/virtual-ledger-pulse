-- Add pending approval status to account_investigations and create approval system
ALTER TYPE investigation_status ADD VALUE IF NOT EXISTS 'PENDING_APPROVAL';
