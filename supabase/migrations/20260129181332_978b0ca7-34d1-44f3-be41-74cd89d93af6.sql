-- Fix the delete_sales_order_with_reversal function to use correct column name
...
BEGIN
    ...
    -- Store client name for orphan cleanup (only use client_name, not customer_name which doesn't exist)
