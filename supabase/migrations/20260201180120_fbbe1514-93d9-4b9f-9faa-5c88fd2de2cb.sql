...
DROP FUNCTION IF EXISTS public.create_manual_purchase_complete_v2(text,text,date,numeric,uuid,numeric,numeric,uuid,text,text,uuid,text,text,numeric,boolean);
DROP FUNCTION IF EXISTS public.create_manual_purchase_complete_v2(text,text,date,text,numeric,numeric,numeric,uuid,uuid,text,uuid,text,text,numeric,boolean);

-- Recreate a single stable signature used by the frontend (named args)
CREATE FUNCTION public.create_manual_purchase_complete_v2(
  p_order_number TEXT,
...
BEGIN
  ...
  -- Bank transaction + balance update
