-- Update the create_manual_purchase_complete_v2 function to include wallet_id
...
BEGIN
  ...
  -- Create purchase order directly as completed (bypass workflow) - NOW INCLUDING wallet_id
  ...
  -- Wallet credit - trigger handles balance update
