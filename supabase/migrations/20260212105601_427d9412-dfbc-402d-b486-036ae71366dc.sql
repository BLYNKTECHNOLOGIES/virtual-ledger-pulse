...
BEGIN
  ...
  -- Idempotency guard using correct reversal_guards schema
  BEGIN
    INSERT INTO reversal_guards (entity_type, entity_id, action) VALUES ('erp_conversion', p_conversion_id::text, 'approve');
