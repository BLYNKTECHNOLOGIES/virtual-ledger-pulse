...
-- Insert opening balance to account for unrecorded initial funding
-- Amount = ABS(min running balance) + small buffer = 4443 USDT
INSERT INTO public.wallet_transactions (wallet_id, transaction_type, amount, asset_code, reference_type, description, balance_before, balance_after, created_at)
VALUES (
  ...
  'USDT',
  'OPENING_BALANCE',
  'Opening balance: unrecorded initial USDT funding prior to ledger tracking',
  0, 0,
  '2026-02-04 19:00:00+00' -- Before the first transaction
);
