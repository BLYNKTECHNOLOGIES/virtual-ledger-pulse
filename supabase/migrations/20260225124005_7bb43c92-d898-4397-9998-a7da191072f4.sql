...
AS $$
BEGIN
  -- DELETE all rows from tables with NOT NULL FK to users
  ...
  -- TEXT columns
  UPDATE public.ad_action_logs SET user_id = '00000000-0000-0000-0000-000000000000' WHERE user_id = p_user_id::text;
  UPDATE public.terminal_sessions SET user_id = '00000000-0000-0000-0000-000000000000' WHERE user_id = p_user_id::text;
