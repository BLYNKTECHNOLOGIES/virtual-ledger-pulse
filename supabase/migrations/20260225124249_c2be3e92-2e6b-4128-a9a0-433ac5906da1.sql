...
BEGIN
  ...
  -- TEXT type columns → NULL (must cast p_user_id to text)
  UPDATE public.account_investigations SET assigned_to = NULL WHERE assigned_to = _tid;
  UPDATE public.ad_action_logs SET user_id = NULL WHERE user_id = _tid;
  ...
  UPDATE public.chat_message_senders SET user_id = NULL WHERE user_id = _tid;
  ...
  UPDATE public.terminal_auto_assignment_log SET assigned_to = NULL WHERE assigned_to = _tid;
  UPDATE public.terminal_mpi_snapshots SET user_id = NULL WHERE user_id = _tid;
