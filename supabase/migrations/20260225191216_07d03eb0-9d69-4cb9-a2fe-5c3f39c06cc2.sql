...
BEGIN
  ...
  ELSIF NEW.transaction_type IN ('DEBIT', 'TRANSFER_OUT') THEN
    ...
    -- Allow reversals, reconciliations, ERP conversions, and manual adjustments
    IF NEW.reference_type NOT IN ('ORDER_DELETION', 'REVERSAL', 'RECONCILIATION', 'EXPENSE_REVERSAL', 'ERP_CONVERSION', 'MANUAL_ADJUSTMENT') 
