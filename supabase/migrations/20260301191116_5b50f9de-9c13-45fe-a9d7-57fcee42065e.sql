-- Ensure CREDIT bank accounts can go negative for manual purchase RPCs
-- while preserving existing behavior for all non-CREDIT accounts.
...
BEGIN
  ...
  -- Only enforce non-negative balance for non-CREDIT accounts
