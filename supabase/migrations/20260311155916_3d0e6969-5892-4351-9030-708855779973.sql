...
CREATE OR REPLACE FUNCTION reconcile_purchase_order_edit(
  p_order_id UUID,
  p_order_number TEXT,
  ...
  p_old_net_payable NUMERIC DEFAULT NULL,
  p_new_net_payable NUMERIC DEFAULT NULL,
  p_old_wallet_id UUID DEFAULT NULL,
  p_new_wallet_id UUID DEFAULT NULL,
  p_old_quantity NUMERIC DEFAULT NULL,
...
BEGIN
  ...
  IF v_quantity_changed OR v_amount_changed THEN
    -- Fixed: use reference_number instead of non-existent order_number column
