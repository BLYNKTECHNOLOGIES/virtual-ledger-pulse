...
BEGIN
  ...
  -- Fixed: use correct column names (amount, description) instead of (quantity, notes)
  IF p_credit_wallet_id IS NOT NULL THEN
    INSERT INTO public.wallet_transactions (
      wallet_id, transaction_type, asset_code, amount, reference_type,
      reference_id, description, balance_before, balance_after, created_by
    ) VALUES (
