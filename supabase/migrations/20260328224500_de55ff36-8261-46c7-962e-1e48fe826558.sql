...
-- B47 FIX: Add reversed_at column and stop deleting settlement items

-- Step 1: Add reversed_at column
ALTER TABLE payment_gateway_settlement_items 
ADD COLUMN IF NOT EXISTS reversed_at TIMESTAMPTZ DEFAULT NULL;

-- Step 2: Replace the function to soft-mark instead of deleting items
