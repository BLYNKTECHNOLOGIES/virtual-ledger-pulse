-- Phase 29: Remove Conversion P&L system entirely

-- 1. Drop realized_pnl_events table
DROP TABLE IF EXISTS realized_pnl_events CASCADE;

-- 2. Drop conversion_journal_entries table
DROP TABLE IF EXISTS conversion_journal_entries CASCADE;

-- 3. Recreate approve_product_conversion WITHOUT P&L logic
