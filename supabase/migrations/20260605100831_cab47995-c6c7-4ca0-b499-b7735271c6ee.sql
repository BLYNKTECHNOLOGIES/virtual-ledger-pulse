ALTER TABLE public.terminal_activity_log ALTER COLUMN user_id DROP NOT NULL;
ALTER TABLE public.terminal_broadcasts ALTER COLUMN created_by DROP NOT NULL;
ALTER TABLE public.terminal_order_escalations ALTER COLUMN escalated_by DROP NOT NULL;
ALTER TABLE public.terminal_order_escalations ALTER COLUMN escalated_to DROP NOT NULL;
ALTER TABLE public.terminal_shift_handovers ALTER COLUMN outgoing_user_id DROP NOT NULL;
ALTER TABLE public.terminal_shift_handovers ALTER COLUMN incoming_user_id DROP NOT NULL;

ALTER TABLE public.terminal_activity_log DROP CONSTRAINT IF EXISTS terminal_activity_log_user_id_fkey;
ALTER TABLE public.terminal_activity_log
  ADD CONSTRAINT terminal_activity_log_user_id_fkey
  FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE SET NULL;

ALTER TABLE public.terminal_broadcasts DROP CONSTRAINT IF EXISTS terminal_broadcasts_created_by_fkey;
ALTER TABLE public.terminal_broadcasts
  ADD CONSTRAINT terminal_broadcasts_created_by_fkey
  FOREIGN KEY (created_by) REFERENCES auth.users(id) ON DELETE SET NULL;

ALTER TABLE public.terminal_order_escalations DROP CONSTRAINT IF EXISTS terminal_order_escalations_escalated_by_fkey;
ALTER TABLE public.terminal_order_escalations
  ADD CONSTRAINT terminal_order_escalations_escalated_by_fkey
  FOREIGN KEY (escalated_by) REFERENCES auth.users(id) ON DELETE SET NULL;

ALTER TABLE public.terminal_order_escalations DROP CONSTRAINT IF EXISTS terminal_order_escalations_escalated_to_fkey;
ALTER TABLE public.terminal_order_escalations
  ADD CONSTRAINT terminal_order_escalations_escalated_to_fkey
  FOREIGN KEY (escalated_to) REFERENCES auth.users(id) ON DELETE SET NULL;

ALTER TABLE public.terminal_order_escalations DROP CONSTRAINT IF EXISTS terminal_order_escalations_resolved_by_fkey;
ALTER TABLE public.terminal_order_escalations
  ADD CONSTRAINT terminal_order_escalations_resolved_by_fkey
  FOREIGN KEY (resolved_by) REFERENCES auth.users(id) ON DELETE SET NULL;

ALTER TABLE public.terminal_shift_handovers DROP CONSTRAINT IF EXISTS terminal_shift_handovers_outgoing_user_id_fkey;
ALTER TABLE public.terminal_shift_handovers
  ADD CONSTRAINT terminal_shift_handovers_outgoing_user_id_fkey
  FOREIGN KEY (outgoing_user_id) REFERENCES auth.users(id) ON DELETE SET NULL;

ALTER TABLE public.terminal_shift_handovers DROP CONSTRAINT IF EXISTS terminal_shift_handovers_incoming_user_id_fkey;
ALTER TABLE public.terminal_shift_handovers
  ADD CONSTRAINT terminal_shift_handovers_incoming_user_id_fkey
  FOREIGN KEY (incoming_user_id) REFERENCES auth.users(id) ON DELETE SET NULL;
...
BEGIN
  ...
  UPDATE public.ad_payment_methods SET created_by_user_id = NULL WHERE created_by_user_id = p_user_id;
