...
BEGIN
  ...
  -- terminal_mpi_snapshots.user_id is NOT NULL and holds per-user performance
  -- analytics with no name column to preserve; remove the deleted user's snapshots.
