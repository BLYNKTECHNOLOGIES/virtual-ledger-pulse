-- 1. Recreate delete_user_with_cleanup without the journal_entries reference
...
-- 2. Drop unused diagnostic view
DROP VIEW IF EXISTS public.daily_reconciliation_summary;

-- 3. Drop confirmed-dead tables
DROP TABLE IF EXISTS public.employee_offboarding;
DROP TABLE IF EXISTS public.journal_entries;
DROP TABLE IF EXISTS public.p2p_order_types;