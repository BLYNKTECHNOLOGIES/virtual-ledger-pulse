...
BEGIN
  ...
  UPDATE public.terminal_small_payment_cases SET payer_user_id = NULL WHERE payer_user_id = p_user_id;
  UPDATE public.terminal_small_payment_cases SET created_by = NULL WHERE created_by = p_user_id;
  UPDATE public.terminal_small_payment_cases SET updated_by = NULL WHERE updated_by = p_user_id;
  ...
  DELETE FROM public.user_sidebar_preferences WHERE user_id = p_user_id;
  ...
  DELETE FROM public.risk_flags WHERE user_id = p_user_id;
  DELETE FROM public.risk_detection_logs WHERE user_id = p_user_id;
  ...
  UPDATE public.terminal_auto_assignment_log SET assigned_to = 'DELETED:' || _full_name WHERE assigned_to = _tid;
