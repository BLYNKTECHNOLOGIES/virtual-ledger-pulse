...
BEGIN
  ...
  LOOP
    ...
    -- Insert repayment with balance_after; trigger updates hr_loans (and closes it).
    v_loan_deduction := 0;
    ...
    LOOP
      ...
      IF v_emi > 0 THEN
        ...
        -- NOTE: do NOT UPDATE hr_loans here. trg_sync_loan_balance already applied balance_after.
      END IF;
    END LOOP;
