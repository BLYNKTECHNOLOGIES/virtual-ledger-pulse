DROP TRIGGER IF EXISTS trg_validate_objective_status ON public.hr_objectives;
DROP FUNCTION IF EXISTS public.validate_objective_status() CASCADE;
DROP TABLE IF EXISTS public.hr_objectives CASCADE;
