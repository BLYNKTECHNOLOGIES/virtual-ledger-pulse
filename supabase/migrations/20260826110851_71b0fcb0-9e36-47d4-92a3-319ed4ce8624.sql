...
BEGIN
  ...
  LOOP
    ...
    -- An approved regularization with a complete in/out pair is authoritative for its
    -- whole attendance window: other device punches in that window are set aside so
    -- the approved times drive worked minutes, status, late, early-out and overtime.
