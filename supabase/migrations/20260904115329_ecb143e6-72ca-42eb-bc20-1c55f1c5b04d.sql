DROP FUNCTION IF EXISTS public.hr_employment_gap_working_days(uuid[], date);
...
GRANT EXECUTE ON FUNCTION public.hr_employment_gap_working_days(uuid[], date) TO authenticated, service_role;