...
BEGIN
  ...
  agg AS (
    SELECT
      ...
      -- Depth coverage across EVERY measured minute: how much of the target
      -- ad count was actually live. 1 of 2 required ads all shift => 0.50.
...
SELECT public.rollup_terminal_ad_uptime('2026-09-16'::date);
SELECT public.rollup_terminal_ad_uptime('2026-09-17'::date);
SELECT public.rollup_terminal_ad_uptime_monthly('2026-09-01'::date);